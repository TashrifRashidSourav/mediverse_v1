        ...
        <div className="min-h-screen bg-slate-100">
            ...
            <main className="container mx-auto px-6 py-12 md:py-20">
                <div className="text-center max-w-3xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900">Find a Specialist</h1>
                ...
                {/* Search Filters */}
                <div className="mt-12 mb-10 max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-md">
